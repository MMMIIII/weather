...
let { settingTempMetric, langModel,nameCountryAndCity, modelCity,feel,maxTemp,minTemp,humidity,pressure,windSpeed,deg,time, } = storeToRefs(store);
let isCollapsed = ref(true);


let stringOptions =  nameCountryAndCity ;
...
store.daysAPI = await WeatherNowAPI(modelCity.value, settingTempMetric.value);
